<body class="bg-default">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-gradient-maroon py-7 py-lg-8 pt-lg-9">
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white animate__animated animate__slideInDown">SIF-OKe</h1>
              <p class="text-lead text-white animate__animated animate__slideInUp">Selamat datang di Sistem Informasi Fakultas Olahraga dan Kesehatan</p>
            </div>
          </div>
        </div>
      </div>
					...
					<div class="card bg-secondary border-0 mb-0">
						<div class="card-body px-lg-5 py-lg-5">
							<div class="text-center text-muted mb-4">
									...
									<div class="row">
										<div class="col-md-12">
										<img class="logo-login animate__animated animate__zoomIn" src="<?= base_url("assets/img/logo_fok.png") ?>" alt="" >
										</div>
										<div class="col-md-12">
										<h4>Login</h4>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2021 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Shan Team</a>
          </div>
        </div>
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="https://www.creative-tim.com" class="nav-link" target="_blank">Developed by Fashan Saraya</a>
            </li>
            <!-- <li class="nav-item">
