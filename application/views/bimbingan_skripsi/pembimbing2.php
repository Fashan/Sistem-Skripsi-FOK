...
<button type="button" id="btn-tambahbp" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-bimbingan" data-id="<?= userdata()->user_id ?>" data-role_id="<?= userdata()->role_id ?>" data-username="<?= userdata()->username ?>" data-role="mahasiswa_pem2">
  <i class="fas fa-users"></i> Tambah Topik 
            ...
            <div class=" py-4  table-responsive">
              <table class="table table-flush" id="datatable-logbimbingan4">
...
<div class="modal fade" id="hapus_bp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
	...
	<div class="form-group">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" id="btn-editbp" class="btn btn-primary" onclick="editlogbp2()" data-role="mahasiswa_pem2">Save</button>
        </form>
      </div>
    </div>
  </div>
