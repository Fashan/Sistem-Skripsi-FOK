...
<div class="row">
	<div class="col-md-12">
			...
			<p class="mt-3">NIM</p>
			<p><?= $mahasiswa->username ?> <?= $keputusan,userdata()->role ?></p>
			<p class="mt-3">Judul</p>
			<p><?= $mahasiswa->judul ?></p>

			<?php if ($penguji[0]->role == "Penguji 1 Proposal" && $absen->penguji_1 == 'hadir') : ?>
				<div class="row"data-aos="fade-up">
				 ...
				 <?php if ($proposal->status_pnj1 == 'belum ACC') : ?>
					<button class="btn btn-primary mt-1" onclick="acc_proposal(<?= $proposal->id ?>,'status_pnj1')">ACC Proposal</button>
					<?php else: ?>
						<button class="btn btn-danger mt-1" onclick="batal_proposal(<?= $proposal->id ?>,'status_pnj1')">batalkan ACC</button>
				 <?php endif ?>
				 </div>
				  </div>
				  </div>
				  ...
				  <p class="text-center mt-2"><?= $proposal->status_pnj2 ?></p>
				  </div>
				  </div>
					</div>
			  </div>
			...
			<div class="col-md-12">
				  <div class="d-flex flex-column">
				  <div class="align-self-center">
				 <div class="unduh-proposal" data-link = "<?= base_url("mahasiswa/download_proposal/".$proposal->file) ?>">
			...
			<?php else: ?>
				<?php if ($penguji[0]->role == 'Penguji 2 Proposal' && $absen->penguji_2 == 'hadir') : ?>
					<div class="row" data-aos="fade-up">
				  <div class="col-md-6">
				  <div class="d-flex flex-column">
				  <div class="align-self-center">
				  <h3 class="mb-0 text-center">Penguji 2</h3>
				 	<div class="button-acc">
					 <?php if ($proposal->status_pnj2 == 'belum ACC') : ?>
					<button class="btn btn-primary mt-1" onclick="acc_proposal(<?= $proposal->id ?>,'status_pnj2')">ACC Proposal</button>
					<?php else: ?>
						<button class="btn btn-danger mt-1" onclick="batal_proposal(<?= $proposal->id ?>,'status_pnj2')">batalkan ACC</button>
					<?php endif ?>
					 </div>
				  </div>
				  </div>
				  ...
				  <div class="align-self-center">
				  <h3 class="mb-0 text-center">Penguji 1</h3>
					<p class="text-center mt-2"> <?= $proposal->status_pnj1 ?></p>
				  </div>
				  </div>
					</div>
			  </div>
...
<button type="button" id="btn-tambahbp" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-bimbingan" data-id="<?= $mahasiswa->user_id ?>" data-role_id="<?= $r->id ?>" data-username="<?= $mahasiswa->username ?>" data-role="<?= str_replace(" ","_",$penguji[0]->role) ?>">
  <i class="fas fa-users"></i> Tambah Topik 
            ...
            <div class=" py-4  table-responsive">
              <table class="table table-flush" id="datatable-logbimbingandosen7">
            ...
            <div class=" py-4  table-responsive">
              <table class="table table-flush" id="datatable-logbimbingandosen8">
                <thead class="thead-light">
                  <tr>
					<th>No</th>
                    <th>Tanggal</th>
