...
class Jadwalyudisium_model extends CI_Model {
...
private function _get_datatables_query() {
	...
	$this->db->from('events');
	$this->db->join('users', 'events.mahasiswa_id = users.user_id AND events.keterangan = \'yudisium\'');
	$i = 0;
...
/* End of file jadwalyudisium.php */
