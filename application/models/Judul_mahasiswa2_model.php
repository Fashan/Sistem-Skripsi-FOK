<?php 
// datatable tampilan di PA
defined('BASEPATH') OR exit('No direct script access allowed');
                        
class Judul_mahasiswa2_model extends CI_Model {
...
private function _get_datatables_query() {
	...
	$this->db->join('users', 'ide_skripsi.mahasiswa_id = users.user_id AND users.pa_id ='.$id);
	$i = 0;
...
/* End of file judul_mahasiswa2.php */
