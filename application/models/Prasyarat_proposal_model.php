...
class Prasyarat_proposal_model extends CI_Model {
...
private function _get_datatables_query() {
	$this->db->select('users.*,prasyarat_proposal.status_prasyarat as status_p,prasyarat_proposal.id as prasyarat_id');
	$this->db->from('users');
	$this->db->join('prasyarat_proposal', 'users.user_id = prasyarat_proposal.mahasiswa_id');
...
function count_all() {
	$this->db->from('prasyarat_proposal');
...
/* End of file prasyarat_proposal.php */
