...
class Jadwalsidang_model extends CI_Model {
...
private function _get_datatables_query() {
	$this->db->select('users.nama, users.username, events.*');
	$this->db->from('events');
	$this->db->join('users', 'events.mahasiswa_id = users.user_id AND events.keterangan = \'sidang skripsi\'');
	$i = 0;
