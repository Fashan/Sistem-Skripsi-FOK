...
class Prasyarat_skripsi_model extends CI_Model {
...
private function _get_datatables_query() {
	$this->db->select('users.*,prasyarat_skripsi.status_prasyarat as status_p,prasyarat_skripsi.id as prasyarat_id');
	$this->db->from('users');
	$this->db->join('prasyarat_skripsi', 'users.user_id = prasyarat_skripsi.mahasiswa_id');
...
function count_all() {
	$this->db->from('prasyarat_skripsi');
...
/* End of file prasyarat_skripsi.php */
